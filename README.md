...
<!-- ABOUT THE PROJECT -->
## About The Project
This project was develouped as an university assignment for my Algorithms cource. The goal of the project was to create an algorithm for generating a gungeon. 
The generation starts with a master room that is then divided into smaller rooms. After that the rooms are connected with doors. 
Finally, a grapht is constructed using DFS (Depth-First Search) and a NavMesh is generated to allow the player to move (the player move by clicking on the screen).
...
* NaughtyAttributes pakcage installed via the Unity Package Manager
...
* Dungeon size - mini(50;50) / small(100;100) / midium(150;150) / large(200;200) / custom
